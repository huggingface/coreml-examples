...
fileprivate let logger = Logger(subsystem: "com.apple.coreml.segmentation", category: "Camera")
...
final class Camera: NSObject {
    ...
    override init() {
        ...
        sessionQueue = DispatchQueue(label: "com.apple.coreml.segmentation.camera")
