...
- How to convert Depth Pro for GPU and Neural Engine. [Source code notebook](tutorials/DepthPro/depth_pro_coreml_guide.ipynb)
- How to convert Depth Anything v2 for GPU and Neural Engine. [Source code notebook](tutorials/depth-anything/depth-anything-coreml-guide.ipynb) <a target="_blank" href="https://colab.research.google.com/github/huggingface/coreml-examples/tutorials/depth-anything-coreml-guide.ipynb">
